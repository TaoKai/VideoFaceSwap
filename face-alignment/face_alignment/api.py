...
default_model_urls = {
    '2DFAN-4': 'face-alignment/models/2DFAN4_1.5-a60332318a.zip',
...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
        ...
        self.face_detector = face_detector_module.FaceDetector(device=device, verbose=verbose, path_to_detector='face-alignment/models/s3fd-619a316812.pth', **face_detector_kwargs)
        ...
        self.face_alignment_net = torch.jit.load('face-alignment/models/2DFAN4_1.5-a60332318a.zip')
