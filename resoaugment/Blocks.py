...
if __name__=='__main__':
    ...
    block = DiscriminatorBlock(128, 128, gain=gain, use_wscale=True, activation_layer=act, blur_kernel=None)
    block2 = DiscriminatorBlock(128, 64, gain=gain, use_wscale=True, activation_layer=act, blur_kernel=None)
    img = torch.randn([5, 128, 256, 256])
    img = block(img)
    out = block2(img)
    print(out, out.shape)
